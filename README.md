...
![Google BigQuery](https://img.shields.io/badge/Google%20BigQuery-669DF6?style=for-the-badge&logo=googlecloud&logoColor=white)
...
* **[Enterprise Logistics ETL Pipeline & Analytics](https://github.com/vishusgh/logistics-etl-pipeline)** 
  Architected an automated Python & SQL ETL pipeline using Google BigQuery to clean fragmented operational data. Built a high-performance Power BI semantic model tracking $91.92M in freight revenue and optimizing regional fleet routing.
